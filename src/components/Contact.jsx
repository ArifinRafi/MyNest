...
const Contact = () => {
    return (
        <div className='relative'>
            <img className='relative inset-0 w-full lg:h-full h-[800px]' src={contact} alt="Background" />
            <div className='absolute lg:mt-24 flex lg:flex-row flex-col items-center p-4 lg:justify-around inset-0 text-white'>
                <div><h1 className='text-3xl font-semibold'>Need the best deal?</h1>
                <h1 className='text-3xl font-semibold'>Contact Us Now!</h1>
                <div className='flex flex-col gap-2'><p className='text-xl lg:mt-24' >Contact</p>
                ...
                <div className='bg-white mt-4 text-black w-96 gap-4 h-80 flex flex-col items-center'>
